...
> {
  ...
  private async handleCreateFolder(
    ...
    if (!parentFolderId)
      return {
        statusCode: 400,
        response: {
          message: 'parentFolderId is required',
          error: 'Bad Request',
        },
      };
    if (!vaultContainerId)
      return {
        statusCode: 400,
        response: {
          message: 'vaultContainerId is required',
          error: 'Bad Request',
        },
      };
    ...
    if (!parsedParentId)
      return {
        statusCode: 400,
        response: {
          message: 'Invalid parentFolderId format',
          error: 'Bad Request',
        },
      };
    ...
    if (!parsedVaultContainerId)
      return {
        statusCode: 400,
        response: {
          message: 'Invalid vaultContainerId format',
          error: 'Bad Request',
        },
      };
  ...
  private async handleGetFolderPath(
    ...
    if (!folderId)
      return {
        statusCode: 400,
        response: { message: 'Invalid folder ID format', error: 'Bad Request' },
      };
  ...
  private async handleMoveItem(
    ...
    if (!itemId)
      return {
        statusCode: 400,
        response: { message: 'Invalid item ID format', error: 'Bad Request' },
      };
    const { itemType, newParentId } = req.body;
    if (!newParentId)
      return {
        statusCode: 400,
        response: { message: 'newParentId is required', error: 'Bad Request' },
      };
    ...
    if (!parsedNewParentId)
      return {
        statusCode: 400,
        response: {
          message: 'Invalid newParentId format',
          error: 'Bad Request',
        },
      };
